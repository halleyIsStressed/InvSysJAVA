...
VALUES
    ...
    ('SP00005', 'P00006', 385, '2024-07-26', 2310, 'Completed'),
    ('SP00009', 'P00010', 324, '2024-08-04', 1944, 'Completed'),
    ('SP00010', 'P00001', 185, '2024-08-16', 1480, 'Completed'),
    ('SP00003', 'P00003', 269, '2024-08-29', 1345, 'Pending'),
    ('SP00007', 'P00009', 175, '2024-09-01', 1575, 'Pending'),
    ('SP00003', 'P00002', 130, '2024-09-08', 0, 'Pending'),
    ('SP00008', 'P00008', 301, '2024-09-14', 0, 'Pending'),
...
VALUES
    ...
    ('P00002', 'BR00003', 56, '2024-07-29', 'Completed'),
    ('P00005', 'BR00002', 44, '2024-08-02', 'Completed'),
...
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00009', 'P00002', 52, 'Expired product');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00002', 'P00003', 73, 'Overstock');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00010', 'P00001', 75, 'Damaged product');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00001', 'P00002', 37, 'Expired product');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00005', 'P00005', 95, 'Damaged product');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00006', 'P00002', 6, 'Overstock');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00002', 'P00002', 29, 'Overstock');
INSERT INTO RETURN_ORDER (SUPPLIER_ID, PRODUCT_ID, QUANTITY, RETURN_REASON) VALUES ('SP00004', 'P00002', 93, 'Expired product');
